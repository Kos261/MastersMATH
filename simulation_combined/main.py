...
def propagate_orbit_rk4(eq_of_motion, state0, t0, tf, dt):
    ...
    for i in range(1, len(times)):
        states[i] = runge_kutta_4(eq_of_motion, times[i-1], states[i-1], dt)
...
if __name__ == "__main__":
    ...
    Shape  (len(time),       4,             6)
    '''
    times, states = propagate_orbit_rk4(core.equations_of_motion, state0, t0, tf, dt)
